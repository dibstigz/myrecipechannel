...
<style>
/*#back-top { position: fixed; bottom: 30px;right:0px;}#back-top  a { width: 108px; display: block; text-align: center; font: 11px/100% Arial, Helvetica, sans-serif; text-transform: uppercase; text-decoration: none; color: #bbb; -webkit-transition: 1s; -moz-transition: 1s; transition: 1s;}#back-top  a:hover { color: #000;}#back-top  span { width: 108px; height: 108px; display: block; margin-bottom: 7px; background: #ddd url(&#39;http://4.bp.blogspot.com/-0mlo-caVkrQ/Ub835FbxwKI/AAAAAAAACv4/y9bfGt2b1fs/s1600/0017.png&#39;) no-repeat center center; -webkit-border-radius: 15px; -moz-border-radius: 15px; border-radius: 15px; -webkit-transition: 1s; -moz-transition: 1s; transition: 1s;}#back-top  a:hover span{background-color: #777;} */
<?php //echo  $box_style; ?>
</style>
<?php wp_head(); ?>
</head>
                 ...
                 <div id="header-search">
					...
					<?php global $user_ID, $user_identity; get_currentuserinfo(); if (!$user_ID) { ?>
					  <!--<li class="acti1"><a href="<?php echo user_template_link(); ?>"><span>Are You New? </span> Register</a></li>-->
						<li class=""><a href="<?php echo user_template_link(); ?>">Register</a></li>
						<li class=""><a href="<?php echo user_template_link(); ?>">Login</a></li>
