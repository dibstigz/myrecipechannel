		...
		<div id="details" class="section-box">
			...
			<div id="info"<?php //if(!empty($info_toggle)) echo ' class="more-less" data-less-height="'.$info_toggle.'"'; ?>>
				...
				<div class="entry-content rich-content">
  				...
  				// find list of events
  				$qry = "SELECT meta_value FROM wp_postmeta WHERE post_id = ".$id." AND meta_key = 'rss_pi_source_url'";

  				$url = $wpdb->get_results( $qry );
      			...
      			echo substr($content, 0, 500)."....";
						...
						echo '<form action="http://ec2-54-79-18-12.ap-southeast-2.compute.amazonaws.com/blogFrame.php" method="post">';
							echo '<input type="hidden" name="url" value="'.$url.'" />';
							echo '<input type="submit" value="Click Here To Read More" />';
						echo '</form>';
					}
					else
					{
