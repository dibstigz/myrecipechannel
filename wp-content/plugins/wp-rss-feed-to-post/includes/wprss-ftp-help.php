...
if ( class_exists('WPRSS_Help') ) {
    ...
    $tooltips = array(
		...
		'force_full_content'		=>	__("Check this box to forcefully attempt to retrieve the full feed content, if the feed only provides excerpts.", WPRSS_TEXT_DOMAIN),
		...
		// Images
		'save_images_locally'		=>	__("Check this box to import the images from the post into your local media library.", WPRSS_TEXT_DOMAIN),
		...
		'use_featured_image'		=>	__("Check this box to enable featured images for imported posts.", WPRSS_TEXT_DOMAIN),
        ...
        // Legacy Feed Items
        'legacy_enabled'			=>	__("Tick this box to re-enable the <strong>Feed Items</strong> and turn off post conversion for some feed sources.
										
										This will also allow you to activate the <strong>Categories</strong> and <strong>Excerpts &amp; Thumbnails</strong> add-ons.", WPRSS_TEXT_DOMAIN),
