...
if( !defined( 'WPRSS_FTP_VERSION' ) )
	define( 'WPRSS_FTP_VERSION', '3.5.1', true );
...
final class WPRSS_FTP {
	...
	*/
	...
	public static function wp_dependancy_msg() {
		return sprintf( __( 'The Feed to Post add-on requires WordPress version <strong>%s</strong> or higher.', WPRSS_TEXT_DOMAIN ), self::WP_MIN_VERSION );
	}
	...
	public static function wprss_dependancy_msg() {
		return sprintf( __( 'Please install and activate WP RSS Aggregator, at version <strong>%s</strong> or higher, for the Feed to Post add-on to work.', WPRSS_TEXT_DOMAIN ), self::WPRSS_MIN_VERSION );
	}
