<div class="wrap ayvpp-wrap">
	...
	<form method="post" action="">
		...
		<table class="form-table">
			...
			<tr valign="top">
				<th scope="row"><label for="import_thumbnails">Import and store video thumbnails locally:</label></th>
				<td>
					<input type="radio" name="import_thumbnails" value="1" <?php if($ayvpp_options['import_thumbnails']) { echo 'checked'; }?> /> yes 
					<input type="radio" name="import_thumbnails" value="0" <?php if(!$ayvpp_options['import_thumbnails']) { echo 'checked'; }?> /> no<br />
					<span class="description">If you set this to yes all images will be imported and stored in your WordPress&trade; uploads folder. The import may slow down the first time viewing of pages on your site which display the thumbnails.</span>
				</td>
			</tr>
			<tr valign="top">
